    ...
    return (
        ...
        rounded-xl shadow-lg shadow-black">
            ...
            <div className="flex justify-between items-center w-[100%]">
                <NavLink to={gitUrl} target='_blank' className='flex justify-center items-center p-3 rounded-md shadow-lg bg-yellow-300 
            hover:-translate-y-2 transition-all duration-150 hover:bg-yellow-400 font-semibold'>
                    GitHub
                </NavLink>
                <NavLink to={liveUrl} target='_blank' className='flex justify-center items-center p-3 rounded-md shadow-lg bg-yellow-300 
            hover:-translate-y-2 transition-all duration-150 hover:bg-yellow-400 font-semibold'>
                    Demo 🚀
                </NavLink>
            </div>
